package com.proof.service.proof.config;
...
public class SwaggerConfig {
    ...
    private static final String TITLE = "PROOF SERVICEREST API";
    private static final Contact CONTACT = new Contact("Fundraising", null,
            "julian.markowskyj@gmail.com.ar");
    private static final String DESCRIPTION = "SERVICIO DE PRUEBA";
